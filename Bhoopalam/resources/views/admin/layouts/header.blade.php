            ...
            <nav class="navbar navbar-expand">
                ...
                <div class="user-box dropdown">
                    <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                        ...
                        @php
                           $media = \App\Models\MediaIcon::first();
                        @endphp
                        <img class="user-img" src="@if(!empty($media->logo)){{url('assets/images/logo/'.$media->logo)}} @else {{asset('assets/images/web2progress.png')}} @endif" alt="preview logo">
...
{{--                            <p class="designattion mb-0">Web Designer</p>--}}
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{url('admin/media-&-icons')}}"><i
                                    class='lni lni-layout'></i><span>Media & Icon</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <form class="dropdown-item" id="logout-form" action="{{ route('logout') }}" method="POST"
                                class="d-none">
                                @csrf
                                <i class='bx bx-log-out-circle'></i> <button class="btn" type="submit">Log Out</button> </form>
                        </li>
                    </ul>
                </div>
            </nav>
